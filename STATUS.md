...
| Manual integral en PDF | 1.541 páginas · ~3,9 MB |
...
|---|---|
| `scripts/generar_clases.py --check` | que ningún README de clase o parte, ni `CURRICULUM.md`, ni el glosario estén desincronizados respecto de su manifiesto, y que no queden carpetas huérfanas |
...
| `python -m unittest discover -s tests` | pruebas estructurales del currículo, los manifiestos y la pedagogía |
