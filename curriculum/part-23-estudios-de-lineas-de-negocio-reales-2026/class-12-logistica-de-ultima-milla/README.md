...
Comprender **logística de última milla** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*validar la densidad necesaria y resolver la figura contractual de los repartidores*.
...
[← 319. Energía solar y servicios de eficiencia](../class-11-energia-solar-y-servicios-de-eficiencia/README.md) · [Índice de la parte](../README.md) · [321. Turismo de experiencias →](../class-13-turismo-de-experiencias/README.md)
