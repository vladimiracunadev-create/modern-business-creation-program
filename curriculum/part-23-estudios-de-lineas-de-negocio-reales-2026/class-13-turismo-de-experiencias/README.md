...
Comprender **turismo de experiencias** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*diseñar el modelo considerando estacionalidad y cumplimiento de normas de seguridad*.
...
[← 320. Logística de última milla](../class-12-logistica-de-ultima-milla/README.md) · [Índice de la parte](../README.md) · [322. Economía circular, reparación y reventa →](../class-14-economia-circular-reparacion-y-reventa/README.md)
