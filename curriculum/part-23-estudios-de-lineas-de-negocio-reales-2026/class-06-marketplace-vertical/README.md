...
Comprender **marketplace vertical** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el nicho de arranque y el mecanismo de liquidez*.
...
[← 313. E-commerce D2C de productos físicos](../class-05-e-commerce-d2c-de-productos-fisicos/README.md) · [Índice de la parte](../README.md) · [315. Educación digital y capacitación empresarial →](../class-07-educacion-digital-y-capacitacion-empresarial/README.md)
