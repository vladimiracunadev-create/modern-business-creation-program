...
Comprender **ciberseguridad administrada para pymes** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el alcance del servicio, el manejo de accesos privilegiados y el límite de responsabilidad*.
...
[← 310. Agencia de automatización e IA aplicada](../class-02-agencia-de-automatizacion-e-ia-aplicada/README.md) · [Índice de la parte](../README.md) · [312. Consultoría tecnológica y modernización →](../class-04-consultoria-tecnologica-y-modernizacion/README.md)
