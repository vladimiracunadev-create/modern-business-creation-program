...
Comprender **fintech regulada y servicios financieros tecnológicos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*determinar qué servicios requieren registro ante la CMF y qué exigen*.
...
- **CMF** — Sistema de Finanzas Abiertas: <https://www.cmfchile.cl/portal/prensa/625/w4-article-110881.html>
...
[← 316. Exportación de servicios de software](../class-08-exportacion-de-servicios-de-software/README.md) · [Índice de la parte](../README.md) · [318. Foodtech, dark kitchen y alimentos →](../class-10-foodtech-dark-kitchen-y-alimentos/README.md)
