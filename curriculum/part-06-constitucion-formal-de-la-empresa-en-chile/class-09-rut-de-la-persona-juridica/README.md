...
Comprender **rut de la persona jurídica** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*obtener el RUT y distinguirlo del inicio de actividades como paso siguiente*.
...
[← 078. Firma electrónica avanzada y firma notarial](../class-08-firma-electronica-avanzada-y-firma-notarial/README.md) · [Índice de la parte](../README.md) · [080. Obtención y resguardo de documentos societarios →](../class-10-obtencion-y-resguardo-de-documentos-societarios/README.md)
