...
**Decisión que habilita:** obtener el RUT y distinguirlo del inicio de actividades como paso siguiente<br>
...
flowchart TB
    ...
    C --> A1["RUT de persona jurídica"]
    C --> A2["Obtención automática"]
    C --> A3["Representante ante el SII"]
    C --> A4["Clave tributaria"]
    A1 & A2 & A3 & A4 --> D{{"obtener el RUT y distinguirlo<br/>del inicio de actividades como<br/>paso siguiente"}}
    D --> E["Entregable<br/>registro del RUT obtenido,<br/>representante ante SII<br/>designado y credenciales<br/>resguardadas"]
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para obtener el RUT y distinguirlo del inicio de actividades como paso siguiente.
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para obtener el RUT y distinguirlo del inicio de actividades como paso siguiente.
