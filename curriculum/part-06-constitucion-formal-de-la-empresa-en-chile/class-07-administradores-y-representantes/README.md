...
**Decisión que habilita:** designar administración y representación con facultades y vigencia claras<br>
...
flowchart TB
    ...
    C --> A1["Administrador"]
    C --> A2["Representante legal"]
    C --> A3["Duración del cargo"]
    C --> A4["Responsabilidad del<br/>administrador"]
    A1 & A2 & A3 & A4 --> D{{"designar administración y<br/>representación con facultades<br/>y vigencia claras"}}
    D --> E["Entregable<br/>acta de designación con<br/>facultades delimitadas y<br/>procedimiento de acreditación<br/>de vigencia"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para designar administración y representación con facultades y vigencia claras.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para designar administración y representación con facultades y vigencia claras.
