...
Comprender **ruta tradicional versus registro de empresas y sociedades** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*elegir la vía de constitución según complejidad estatutaria y tipo de aportes*.
...
[Índice de la parte](../README.md) · [072. Tu Empresa en un Día: flujo completo →](../class-02-tu-empresa-en-un-dia-flujo-completo/README.md)
