...
Comprender **firma electrónica avanzada y firma notarial** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*resolver el mecanismo de firma de cada constituyente antes de iniciar el trámite*.
...
[← 077. Administradores y representantes](../class-07-administradores-y-representantes/README.md) · [Índice de la parte](../README.md) · [079. RUT de la persona jurídica →](../class-09-rut-de-la-persona-juridica/README.md)
