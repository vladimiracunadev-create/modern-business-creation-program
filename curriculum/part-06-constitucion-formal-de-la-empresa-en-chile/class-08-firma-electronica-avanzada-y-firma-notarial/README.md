...
**Decisión que habilita:** resolver el mecanismo de firma de cada constituyente antes de iniciar el trámite<br>
...
flowchart TB
    ...
    C --> A1["Firma electrónica avanzada"]
    C --> A2["Firma electrónica simple"]
    C --> A3["Proveedor acreditado"]
    C --> A4["Firma ante notario"]
    A1 & A2 & A3 & A4 --> D{{"resolver el mecanismo de firma<br/>de cada constituyente antes de<br/>iniciar el trámite"}}
    D --> E["Entregable<br/>checklist de firma por<br/>constituyente con proveedor,<br/>plazo y alternativa notarial"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para resolver el mecanismo de firma de cada constituyente antes de iniciar el trámite.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para resolver el mecanismo de firma de cada constituyente antes de iniciar el trámite.
