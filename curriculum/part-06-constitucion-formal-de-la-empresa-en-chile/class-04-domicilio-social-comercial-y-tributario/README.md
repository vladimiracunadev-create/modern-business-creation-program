...
Comprender **domicilio social, comercial y tributario** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir los tres domicilios y asegurar la documentación que los acredita*.
...
[← 073. Definir razón social, nombre de fantasía y objeto](../class-03-definir-razon-social-nombre-de-fantasia-y-objeto/README.md) · [Índice de la parte](../README.md) · [075. Capital social y forma de enterarlo →](../class-05-capital-social-y-forma-de-enterarlo/README.md)
