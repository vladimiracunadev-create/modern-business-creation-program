...
**Decisión que habilita:** definir quién representa a la sociedad, en qué materias y hasta qué monto<br>
...
flowchart TB
    ...
    C --> A1["Administración"]
    C --> A2["Poder"]
    C --> A3["Representación legal"]
    C --> A4["Actuación conjunta"]
    A1 & A2 & A3 & A4 --> D{{"definir quién representa a la<br/>sociedad, en qué materias y<br/>hasta qué monto"}}
    D --> E["Entregable<br/>matriz de poderes con materia,<br/>monto, firma requerida y<br/>vigencia"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para definir quién representa a la sociedad, en qué materias y hasta qué monto.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para definir quién representa a la sociedad, en qué materias y hasta qué monto.
