...
**Decisión que habilita:** definir cómo se aprueban y registran las operaciones con partes relacionadas<br>
...
flowchart TB
    ...
    C --> A2["Parte relacionada"]
    C --> A3["Operación con parte<br/>relacionada"]
    C --> A4["Deber de lealtad"]
    A1 & A2 & A3 & A4 --> D{{"definir cómo se aprueban y<br/>registran las operaciones con<br/>partes relacionadas"}}
    D --> E["Entregable<br/>política de partes<br/>relacionadas con registro de<br/>operaciones y criterio de<br/>precio de mercado"]
