...
**Decisión que habilita:** decidir si la actividad se ejerce como persona natural o mediante persona jurídica<br>
...
flowchart TB
    ...
    C --> A1["Persona natural"]
    C --> A2["Persona jurídica"]
    C --> A3["Responsabilidad limitada"]
    C --> A4["Levantamiento del velo"]
    A1 & A2 & A3 & A4 --> D{{"decidir si la actividad se<br/>ejerce como persona natural o<br/>mediante persona jurídica"}}
    D --> E["Entregable<br/>comparación fundamentada de<br/>ambas vías con exposición<br/>patrimonial y costo anual<br/>estimado"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para decidir si la actividad se ejerce como persona natural o mediante persona jurídica.
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para decidir si la actividad se ejerce como persona natural o mediante persona jurídica.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para decidir si la actividad se ejerce como persona natural o mediante persona jurídica.
