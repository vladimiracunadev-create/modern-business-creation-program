...
**Decisión que habilita:** determinar si la estabilidad de socios justifica la rigidez de la SRL<br>
...
flowchart TB
    ...
    C --> A1["Sociedad de<br/>responsabilidad limitada"]
    C --> A2["Cesión de derechos"]
    C --> A3["Intuito personae"]
    C --> A4["Modificación estatutaria"]
    A1 & A2 & A3 & A4 --> D{{"determinar si la estabilidad<br/>de socios justifica la rigidez<br/>de la SRL"}}
    D --> E["Entregable<br/>evaluación de SRL para el<br/>caso, con costo y<br/>procedimiento de una<br/>modificación estatutaria"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para determinar si la estabilidad de socios justifica la rigidez de la SRL.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para determinar si la estabilidad de socios justifica la rigidez de la SRL.
