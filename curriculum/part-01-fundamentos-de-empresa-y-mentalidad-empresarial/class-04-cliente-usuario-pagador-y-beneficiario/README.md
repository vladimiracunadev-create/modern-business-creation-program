...
**Decisión que habilita:** mapear quién decide, quién usa, quién paga y quién se beneficia en el proceso de compra<br>
...
flowchart TB
    ...
    C --> A3["Pagador"]
    C --> A4["Beneficiario"]
    A1 & A2 & A3 & A4 --> D{{"mapear quién decide, quién<br/>usa, quién paga y quién se<br/>beneficia en el proceso de<br/>compra"}}
    D --> E["Entregable<br/>mapa de roles de compra con el<br/>criterio de decisión de cada<br/>uno"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para mapear quién decide, quién usa, quién paga y quién se beneficia en el proceso de compra.
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para mapear quién decide, quién usa, quién paga y quién se beneficia en el proceso de compra.
...
- *Uso en esta clase:* aporta el marco de «Fomento para micro y pequeñas empresas» para mapear quién decide, quién usa, quién paga y quién se beneficia en el proceso de compra.
