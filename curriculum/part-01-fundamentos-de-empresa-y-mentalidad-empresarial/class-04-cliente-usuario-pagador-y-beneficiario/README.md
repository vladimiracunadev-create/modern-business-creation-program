...
Comprender **cliente, usuario, pagador y beneficiario** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*mapear quién decide, quién usa, quién paga y quién se beneficia en el proceso de compra*.
...
[← 003. Problema, necesidad, deseo y trabajo por resolver](../class-03-problema-necesidad-deseo-y-trabajo-por-resolver/README.md) · [Índice de la parte](../README.md) · [005. Producto, servicio, solución y experiencia →](../class-05-producto-servicio-solucion-y-experiencia/README.md)
