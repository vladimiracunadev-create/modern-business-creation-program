...
**Decisión que habilita:** clasificar correctamente cada salida de dinero antes de proyectar rentabilidad<br>
...
flowchart TB
    ...
    C --> A3["Gasto"]
    C --> A4["Inversión"]
    A1 & A2 & A3 & A4 --> D{{"clasificar correctamente cada<br/>salida de dinero antes de<br/>proyectar rentabilidad"}}
    D --> E["Entregable<br/>clasificación de las veinte<br/>salidas de dinero más grandes<br/>en costo, gasto o inversión"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para clasificar correctamente cada salida de dinero antes de proyectar rentabilidad.
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para clasificar correctamente cada salida de dinero antes de proyectar rentabilidad.
...
- *Uso en esta clase:* aporta el marco de «Fomento para micro y pequeñas empresas» para clasificar correctamente cada salida de dinero antes de proyectar rentabilidad.
