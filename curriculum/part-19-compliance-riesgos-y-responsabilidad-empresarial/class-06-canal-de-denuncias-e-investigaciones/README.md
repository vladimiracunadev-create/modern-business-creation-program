...
**Decisión que habilita:** implementar el canal y el procedimiento de investigación con garantías reales<br>
...
flowchart TB
    ...
    C --> A1["Canal de denuncias"]
    C --> A2["Confidencialidad"]
    C --> A3["No represalia"]
    C --> A4["Investigación interna"]
    A1 & A2 & A3 & A4 --> D{{"implementar el canal y el<br/>procedimiento de investigación<br/>con garantías reales"}}
    D --> E["Entregable<br/>procedimiento de canal de<br/>denuncias con<br/>confidencialidad, plazos,<br/>investigador independiente y<br/>registro"]
...
- *Uso en esta clase:* aporta el marco de «Relaciones laborales y obligaciones del empleador» para implementar el canal y el procedimiento de investigación con garantías reales.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para implementar el canal y el procedimiento de investigación con garantías reales.
