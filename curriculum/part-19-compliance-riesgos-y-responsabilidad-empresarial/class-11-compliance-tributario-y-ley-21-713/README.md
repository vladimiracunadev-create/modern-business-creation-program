...
Comprender **compliance tributario y ley 21.713** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*documentar la razón de negocios de cada estructura u operación relevante*.
...
[← 262. Fraude interno y segregación de funciones](../class-10-fraude-interno-y-segregacion-de-funciones/README.md) · [Índice de la parte](../README.md) · [264. Ciberseguridad y obligaciones sectoriales →](../class-12-ciberseguridad-y-obligaciones-sectoriales/README.md)
