...
Comprender **mapa integral de riesgos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar y priorizar los riesgos con responsable y control por cada uno*.
...
[Índice de la parte](../README.md) · [254. Controles preventivos, detectivos y correctivos →](../class-02-controles-preventivos-detectivos-y-correctivos/README.md)
