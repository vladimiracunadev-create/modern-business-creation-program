...
**Decisión que habilita:** determinar qué riesgos se transfieren a seguro y verificar sus exclusiones<br>
...
flowchart TB
    ...
    C --> A1["Seguro empresarial"]
    C --> A2["Cobertura"]
    C --> A3["Exclusión"]
    C --> A4["Deducible"]
    A1 & A2 & A3 & A4 --> D{{"determinar qué riesgos se<br/>transfieren a seguro y<br/>verificar sus exclusiones"}}
    D --> E["Entregable<br/>programa de seguros con<br/>riesgos cubiertos, exclusiones<br/>relevantes, deducibles y sumas<br/>aseguradas"]
...
- *Uso en esta clase:* aporta el marco de «Registro de Prestadores de Servicios Financieros · Ley 21.521» para determinar qué riesgos se transfieren a seguro y verificar sus exclusiones.
