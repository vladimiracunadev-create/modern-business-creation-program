...
Comprender **kyc, pep, beneficiario final y debida diligencia** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el procedimiento de conocimiento del cliente y su actualización*.
...
[← 259. UAF, Ley 19.913 y sujetos obligados](../class-07-uaf-ley-19-913-y-sujetos-obligados/README.md) · [Índice de la parte](../README.md) · [261. Anticorrupción, regalos y conflictos →](../class-09-anticorrupcion-regalos-y-conflictos/README.md)
