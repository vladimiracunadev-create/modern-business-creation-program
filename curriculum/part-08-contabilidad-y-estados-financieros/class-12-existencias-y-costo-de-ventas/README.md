...
Comprender **existencias y costo de ventas** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir método de valorización y frecuencia de conteo físico*.
...
[← 109. Cuentas por pagar y cierre mensual](../class-11-cuentas-por-pagar-y-cierre-mensual/README.md) · [Índice de la parte](../README.md) · [111. Activos fijos, depreciación e intangibles →](../class-13-activos-fijos-depreciacion-e-intangibles/README.md)
