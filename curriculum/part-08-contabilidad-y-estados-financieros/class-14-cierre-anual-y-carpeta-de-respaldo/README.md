...
**Decisión que habilita:** definir la estructura y custodia de la carpeta de respaldo anual<br>
...
flowchart TB
    ...
    C --> A1["Cierre anual"]
    C --> A2["Carpeta de respaldo"]
    C --> A3["Plazo de conservación"]
    C --> A4["Carpeta tributaria<br/>electrónica"]
    A1 & A2 & A3 & A4 --> D{{"definir la estructura y<br/>custodia de la carpeta de<br/>respaldo anual"}}
    D --> E["Entregable<br/>índice de carpeta de respaldo<br/>anual con ubicación,<br/>responsable y plazo de<br/>conservación"]
...
- *Uso en esta clase:* aporta el marco de «Carpeta Tributaria Electrónica» para definir la estructura y custodia de la carpeta de respaldo anual.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para definir la estructura y custodia de la carpeta de respaldo anual.
