...
Comprender **contabilidad como sistema de información** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir para qué decisiones debe servir la contabilidad además de cumplir*.
...
[Índice de la parte](../README.md) · [100. Plan de cuentas →](../class-02-plan-de-cuentas/README.md)
