...
Comprender **conciliación bancaria** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*establecer la conciliación bancaria como control mensual obligatorio*.
...
[← 106. Estado de flujo de efectivo](../class-08-estado-de-flujo-de-efectivo/README.md) · [Índice de la parte](../README.md) · [108. Cuentas por cobrar y provisiones →](../class-10-cuentas-por-cobrar-y-provisiones/README.md)
