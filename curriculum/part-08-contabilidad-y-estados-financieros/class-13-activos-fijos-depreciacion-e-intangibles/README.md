...
Comprender **activos fijos, depreciación e intangibles** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el tratamiento de activos fijos e intangibles y su efecto tributario*.
...
[← 110. Existencias y costo de ventas](../class-12-existencias-y-costo-de-ventas/README.md) · [Índice de la parte](../README.md) · [112. Cierre anual y carpeta de respaldo →](../class-14-cierre-anual-y-carpeta-de-respaldo/README.md)
