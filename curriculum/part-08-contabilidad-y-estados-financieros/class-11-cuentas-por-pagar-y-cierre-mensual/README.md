...
Comprender **cuentas por pagar y cierre mensual** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el checklist y el calendario del cierre mensual*.
...
[← 108. Cuentas por cobrar y provisiones](../class-10-cuentas-por-cobrar-y-provisiones/README.md) · [Índice de la parte](../README.md) · [110. Existencias y costo de ventas →](../class-12-existencias-y-costo-de-ventas/README.md)
