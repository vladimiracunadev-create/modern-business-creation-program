...
Comprender **devengo versus caja** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cuándo se reconoce el ingreso y cómo se controla el diferimiento*.
...
[← 102. Libro diario, mayor y auxiliares](../class-04-libro-diario-mayor-y-auxiliares/README.md) · [Índice de la parte](../README.md) · [104. Balance general →](../class-06-balance-general/README.md)
