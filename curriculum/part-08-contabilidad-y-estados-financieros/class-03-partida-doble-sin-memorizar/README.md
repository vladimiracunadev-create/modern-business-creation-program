...
Comprender **partida doble sin memorizar** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*registrar correctamente las operaciones típicas del negocio*.
...
[← 100. Plan de cuentas](../class-02-plan-de-cuentas/README.md) · [Índice de la parte](../README.md) · [102. Libro diario, mayor y auxiliares →](../class-04-libro-diario-mayor-y-auxiliares/README.md)
