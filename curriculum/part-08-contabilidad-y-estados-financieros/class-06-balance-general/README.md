...
**Decisión que habilita:** evaluar la posición financiera real detrás de las cifras del balance<br>
...
flowchart TB
    ...
    C --> A1["Balance general"]
    C --> A2["Liquidez"]
    C --> A3["Endeudamiento"]
    C --> A4["Calidad del activo"]
    A1 & A2 & A3 & A4 --> D{{"evaluar la posición financiera<br/>real detrás de las cifras del<br/>balance"}}
    D --> E["Entregable<br/>análisis de balance con<br/>liquidez, endeudamiento y<br/>ajustes de calidad de activos"]
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para evaluar la posición financiera real detrás de las cifras del balance.
...
- *Uso en esta clase:* aporta el marco de «Carpeta Tributaria Electrónica» para evaluar la posición financiera real detrás de las cifras del balance.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para evaluar la posición financiera real detrás de las cifras del balance.
