...
Comprender **balance general** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*evaluar la posición financiera real detrás de las cifras del balance*.
...
[← 103. Devengo versus caja](../class-05-devengo-versus-caja/README.md) · [Índice de la parte](../README.md) · [105. Estado de resultados →](../class-07-estado-de-resultados/README.md)
