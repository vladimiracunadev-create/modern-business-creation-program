...
Comprender **libro diario, mayor y auxiliares** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir qué auxiliares se llevarán y con qué frecuencia se cuadran*.
...
[← 101. Partida doble sin memorizar](../class-03-partida-doble-sin-memorizar/README.md) · [Índice de la parte](../README.md) · [103. Devengo versus caja →](../class-05-devengo-versus-caja/README.md)
