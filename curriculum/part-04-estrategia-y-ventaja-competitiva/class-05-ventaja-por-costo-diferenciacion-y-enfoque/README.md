...
Comprender **ventaja por costo, diferenciación y enfoque** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*elegir una estrategia genérica y aceptar lo que implica renunciar*.
...
[← 046. Cadena de valor](../class-04-cadena-de-valor/README.md) · [Índice de la parte](../README.md) · [048. Efectos de red y economías de escala →](../class-06-efectos-de-red-y-economias-de-escala/README.md)
