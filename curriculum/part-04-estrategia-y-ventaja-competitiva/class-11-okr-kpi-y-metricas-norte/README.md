...
Comprender **okr, kpi y métricas norte** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la métrica norte y los resultados clave del período*.
...
[← 052. Portafolio de apuestas y opciones reales](../class-10-portafolio-de-apuestas-y-opciones-reales/README.md) · [Índice de la parte](../README.md) · [054. Roadmap estratégico de 12, 36 y 60 meses →](../class-12-roadmap-estrategico-de-12-36-y-60-meses/README.md)
