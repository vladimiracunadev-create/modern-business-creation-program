...
Comprender **cinco fuerzas y estructura competitiva** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir si la estructura de la industria admite el margen que el negocio necesita*.
...
[← 044. Análisis PESTEL](../class-02-analisis-pestel/README.md) · [Índice de la parte](../README.md) · [046. Cadena de valor →](../class-04-cadena-de-valor/README.md)
