...
Comprender **revisión estratégica y kill criteria** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir qué iniciativas continúan, cuáles se ajustan y cuáles se detienen*.
...
Fundador o directorio, consultor de estrategia, control de gestión. La participación concreta depende del riesgo, el tamaño de la
...
[← 055. Escenarios y señales tempranas](../class-13-escenarios-y-senales-tempranas/README.md) · [Índice de la parte](../README.md) · [057. Persona natural versus persona jurídica →](../../part-05-diseno-societario-y-gobierno-inicial/class-01-persona-natural-versus-persona-juridica/README.md)
