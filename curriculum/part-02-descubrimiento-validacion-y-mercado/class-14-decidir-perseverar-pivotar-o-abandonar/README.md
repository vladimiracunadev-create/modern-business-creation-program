...
Comprender **decidir: perseverar, pivotar o abandonar** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir con criterio preestablecido si se persevera, se pivota o se abandona*.
...
[← 027. Precio como experimento de mercado](../class-13-precio-como-experimento-de-mercado/README.md) · [Índice de la parte](../README.md) · [029. Business Model Canvas →](../../part-03-modelos-de-negocio-y-lineas-de-ingreso/class-01-business-model-canvas/README.md)
