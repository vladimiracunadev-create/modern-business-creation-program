...
Comprender **mapa de alternativas actuales del cliente** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*determinar si la mejora ofrecida supera el costo de cambio del cliente*.
...
[← 021. Competidores directos, indirectos y sustitutos](../class-07-competidores-directos-indirectos-y-sustitutos/README.md) · [Índice de la parte](../README.md) · [023. Propuesta de valor y diferenciación →](../class-09-propuesta-de-valor-y-diferenciacion/README.md)
