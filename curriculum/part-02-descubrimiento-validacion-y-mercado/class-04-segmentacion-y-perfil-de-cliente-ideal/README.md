...
Comprender **segmentación y perfil de cliente ideal** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir a qué segmento se dirige la empresa y a cuáles renuncia explícitamente*.
...
[← 017. Entrevistas de descubrimiento sin sesgos](../class-03-entrevistas-de-descubrimiento-sin-sesgos/README.md) · [Índice de la parte](../README.md) · [019. Jobs to Be Done y resultados esperados →](../class-05-jobs-to-be-done-y-resultados-esperados/README.md)
