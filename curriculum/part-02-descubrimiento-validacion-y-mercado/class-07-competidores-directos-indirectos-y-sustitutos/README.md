# Clase 021 — Competidores directos, indirectos y sustitutos

> **Parte 02 · Descubrimiento, validación y mercado** — clase 7 de 14
...
3. **Decidir** —identificar contra qué compite realmente la oferta en la decisión del cliente— y justificar la decisión por escrito.
...
flowchart TB
    ...
    C --> A1["Competidor directo"]
    C --> A2["Competidor indirecto"]
    C --> A3["Sustituto"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para identificar contra qué compite realmente la oferta en la decisión del cliente.
...
- *Uso en esta clase:* aporta el marco de «Fomento para micro y pequeñas empresas» para identificar contra qué compite realmente la oferta en la decisión del cliente.
...
- *Uso en esta clase:* aporta el marco de «Programas, estudios de mercado y promoción» para identificar contra qué compite realmente la oferta en la decisión del cliente.
...
|---|---|---|
| [← 020 · Tamaño de mercado TAM SAM SOM](../class-06-tamano-de-mercado-tam-sam-som/README.md) | [Parte 02](../README.md) · [Programa](../../../README.md) | [022 · Mapa de alternativas actuales del cliente →](../class-08-mapa-de-alternativas-actuales-del-cliente/README.md) |
