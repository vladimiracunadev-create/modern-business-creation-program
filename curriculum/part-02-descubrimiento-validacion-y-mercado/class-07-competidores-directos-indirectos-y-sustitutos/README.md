...
Comprender **competidores directos, indirectos y sustitutos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar contra qué compite realmente la oferta en la decisión del cliente*.
...
Fundador, investigador de mercado, analista de datos. La participación concreta depende del riesgo, el tamaño de la
...
[← 020. Tamaño de mercado TAM SAM SOM](../class-06-tamano-de-mercado-tam-sam-som/README.md) · [Índice de la parte](../README.md) · [022. Mapa de alternativas actuales del cliente →](../class-08-mapa-de-alternativas-actuales-del-cliente/README.md)
