...
Comprender **mvp, prototipo y concierge test** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir qué se entrega manualmente y qué se automatiza en la primera versión*.
...
[← 025. Experimentos de demanda antes de invertir](../class-11-experimentos-de-demanda-antes-de-invertir/README.md) · [Índice de la parte](../README.md) · [027. Precio como experimento de mercado →](../class-13-precio-como-experimento-de-mercado/README.md)
