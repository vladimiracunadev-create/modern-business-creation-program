...
Comprender **hipótesis críticas del negocio** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*priorizar qué supuestos se prueban primero y con qué presupuesto*.
...
[← 023. Propuesta de valor y diferenciación](../class-09-propuesta-de-valor-y-diferenciacion/README.md) · [Índice de la parte](../README.md) · [025. Experimentos de demanda antes de invertir →](../class-11-experimentos-de-demanda-antes-de-invertir/README.md)
