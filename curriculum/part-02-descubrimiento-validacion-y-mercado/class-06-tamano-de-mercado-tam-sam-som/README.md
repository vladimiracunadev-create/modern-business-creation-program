...
Comprender **tamaño de mercado tam sam som** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*dimensionar el mercado con supuestos que un tercero pueda auditar*.
...
[← 019. Jobs to Be Done y resultados esperados](../class-05-jobs-to-be-done-y-resultados-esperados/README.md) · [Índice de la parte](../README.md) · [021. Competidores directos, indirectos y sustitutos →](../class-07-competidores-directos-indirectos-y-sustitutos/README.md)
