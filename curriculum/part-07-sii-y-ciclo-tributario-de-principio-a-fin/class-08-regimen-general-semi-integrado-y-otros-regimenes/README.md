...
**Decisión que habilita:** determinar si el caso obliga o conviene el régimen general y qué capacidad contable exige<br>
...
flowchart TB
    ...
    C --> A1["Régimen general semi<br/>integrado"]
    C --> A2["Restitución"]
    C --> A3["Registros empresariales"]
    C --> A4["Renta presunta"]
    A1 & A2 & A3 & A4 --> D{{"determinar si el caso obliga o<br/>conviene el régimen general y<br/>qué capacidad contable exige"}}
    D --> E["Entregable<br/>evaluación del régimen general<br/>con requerimientos de<br/>contabilidad y registros<br/>empresariales"]
...
- *Uso en esta clase:* aporta el marco de «Regímenes tributarios · Operación Renta 2026» para determinar si el caso obliga o conviene el régimen general y qué capacidad contable exige.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para determinar si el caso obliga o conviene el régimen general y qué capacidad contable exige.
