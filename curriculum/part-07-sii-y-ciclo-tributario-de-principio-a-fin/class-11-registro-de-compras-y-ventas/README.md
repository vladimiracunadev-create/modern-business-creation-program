...
Comprender **registro de compras y ventas** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la rutina de revisión, aceptación o reclamo de documentos recibidos*.
...
- **Servicio de Impuestos Internos** — Registro de Compras y Ventas: <https://www.sii.cl/destacados/f29/registrocompraventas.htm>
...
[← 094. Documentos tributarios electrónicos DTE](../class-10-documentos-tributarios-electronicos-dte/README.md) · [Índice de la parte](../README.md) · [096. Formulario 29, PPM y ciclo mensual →](../class-12-formulario-29-ppm-y-ciclo-mensual/README.md)
