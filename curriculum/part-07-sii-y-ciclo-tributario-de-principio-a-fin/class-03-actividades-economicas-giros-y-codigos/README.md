...
**Decisión que habilita:** seleccionar los códigos de actividad que cubren el negocio actual y previsto<br>
...
flowchart TB
    ...
    C --> A1["Código de actividad<br/>económica"]
    C --> A2["Giro principal"]
    C --> A3["Giro secundario"]
    C --> A4["Afectación a IVA"]
    A1 & A2 & A3 & A4 --> D{{"seleccionar los códigos de<br/>actividad que cubren el<br/>negocio actual y previsto"}}
    D --> E["Entregable<br/>listado de códigos<br/>seleccionados con<br/>justificación y condición de<br/>afectación a IVA"]
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para seleccionar los códigos de actividad que cubren el negocio actual y previsto.
