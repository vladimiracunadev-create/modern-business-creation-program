...
Comprender **inicio de actividades en sii** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*declarar inicio de actividades con giros correctos y régimen elegido*.
...
[← 085. Arquitectura tributaria chilena para empresas](../class-01-arquitectura-tributaria-chilena-para-empresas/README.md) · [Índice de la parte](../README.md) · [087. Actividades económicas, giros y códigos →](../class-03-actividades-economicas-giros-y-codigos/README.md)
