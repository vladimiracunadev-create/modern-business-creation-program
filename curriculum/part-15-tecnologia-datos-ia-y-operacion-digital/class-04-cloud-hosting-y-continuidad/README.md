...
Comprender **cloud, hosting y continuidad** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*elegir infraestructura considerando disponibilidad, ubicación de datos y costo de salida*.
...
[← 199. Dominio, correo, identidad y accesos](../class-03-dominio-correo-identidad-y-accesos/README.md) · [Índice de la parte](../README.md) · [201. Backups y recuperación →](../class-05-backups-y-recuperacion/README.md)
