...
Comprender **comprar, construir o integrar software** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir qué se compra, qué se construye y qué se integra*.
...
[← 197. Arquitectura tecnológica mínima viable](../class-01-arquitectura-tecnologica-minima-viable/README.md) · [Índice de la parte](../README.md) · [199. Dominio, correo, identidad y accesos →](../class-03-dominio-correo-identidad-y-accesos/README.md)
