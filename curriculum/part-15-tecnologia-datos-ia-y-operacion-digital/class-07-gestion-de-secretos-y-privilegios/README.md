...
Comprender **gestión de secretos y privilegios** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cómo se almacenan, comparten y rotan las credenciales*.
...
[← 202. Ciberseguridad por capas para pyme](../class-06-ciberseguridad-por-capas-para-pyme/README.md) · [Índice de la parte](../README.md) · [204. Datos maestros y calidad de datos →](../class-08-datos-maestros-y-calidad-de-datos/README.md)
