...
Comprender **ia generativa en operaciones** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir casos de uso permitidos, datos autorizados y control de revisión*.
...
[← 206. Automatización de procesos](../class-10-automatizacion-de-procesos/README.md) · [Índice de la parte](../README.md) · [208. Agentes de IA con humano en el circuito →](../class-12-agentes-de-ia-con-humano-en-el-circuito/README.md)
