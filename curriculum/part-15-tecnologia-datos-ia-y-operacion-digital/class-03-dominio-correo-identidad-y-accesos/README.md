...
Comprender **dominio, correo, identidad y accesos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la administración de identidad y el ciclo de vida de los accesos*.
...
[← 198. Comprar, construir o integrar software](../class-02-comprar-construir-o-integrar-software/README.md) · [Índice de la parte](../README.md) · [200. Cloud, hosting y continuidad →](../class-04-cloud-hosting-y-continuidad/README.md)
