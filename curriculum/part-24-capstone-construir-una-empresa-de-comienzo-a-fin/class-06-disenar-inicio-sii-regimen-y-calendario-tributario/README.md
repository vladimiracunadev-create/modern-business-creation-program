...
**Decisión que habilita:** diseñar el inicio SII, el régimen y el calendario tributario del caso<br>
...
flowchart TB
    ...
    C --> A1["Inicio de actividades del<br/>caso"]
    C --> A2["Régimen tributario"]
    C --> A3["Calendario tributario"]
    C --> A4["Provisión de impuestos"]
    A1 & A2 & A3 & A4 --> D{{"diseñar el inicio SII, el<br/>régimen y el calendario<br/>tributario del caso"}}
    D --> E["Entregable<br/>diseño tributario del caso con<br/>códigos, simulación de<br/>regímenes y calendario de<br/>obligaciones"]
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para diseñar el inicio SII, el régimen y el calendario tributario del caso.
...
- *Uso en esta clase:* aporta el marco de «Regímenes tributarios · Operación Renta 2026» para diseñar el inicio SII, el régimen y el calendario tributario del caso.

**Servicio de Impuestos Internos — Registro de Compras y Ventas**  
<https://www.sii.cl/destacados/f29/registrocompraventas.htm> · verificado 2026-09-01
...
- *Uso en esta clase:* aporta el marco de «Registro de Compras y Ventas» para diseñar el inicio SII, el régimen y el calendario tributario del caso.
