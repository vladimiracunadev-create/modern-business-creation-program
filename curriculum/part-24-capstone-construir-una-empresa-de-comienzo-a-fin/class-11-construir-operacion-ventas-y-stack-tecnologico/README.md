...
Comprender **construir operación, ventas y stack tecnológico** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*diseñar la operación, el motor comercial y el stack tecnológico del caso*.
...
[← 332. Diseñar estructura de cargos y responsabilidades](../class-10-disenar-estructura-de-cargos-y-responsabilidades/README.md) · [Índice de la parte](../README.md) · [334. Preparar financiación y data room →](../class-12-preparar-financiacion-y-data-room/README.md)
