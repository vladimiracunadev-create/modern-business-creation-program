...
**Decisión que habilita:** ejecutar la simulación de constitución y armar la carpeta legal del caso<br>
...
flowchart TB
    ...
    C --> A1["Carpeta legal"]
    C --> A2["Simulación de constitución"]
    C --> A3["Objeto social"]
    C --> A4["Acreditación de domicilio"]
    A1 & A2 & A3 & A4 --> D{{"ejecutar la simulación de<br/>constitución y armar la<br/>carpeta legal del caso"}}
    D --> E["Entregable<br/>carpeta legal simulada con<br/>formulario completo, objeto,<br/>capital, poderes y<br/>acreditación de domicilio"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para ejecutar la simulación de constitución y armar la carpeta legal del caso.
...
- *Uso en esta clase:* aporta el marco de «Marcas, patentes y diseños industriales» para ejecutar la simulación de constitución y armar la carpeta legal del caso.
