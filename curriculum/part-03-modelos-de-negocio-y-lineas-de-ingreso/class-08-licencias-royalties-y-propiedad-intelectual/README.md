...
Comprender **licencias, royalties y propiedad intelectual** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*determinar qué derecho existe, si está registrado y bajo qué condiciones se licencia*.
...
[← 035. Marketplace de dos lados](../class-07-marketplace-de-dos-lados/README.md) · [Índice de la parte](../README.md) · [037. Agencia y servicios administrados →](../class-09-agencia-y-servicios-administrados/README.md)
