...
Comprender **agencia y servicios administrados** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la mezcla entre proyecto y retainer y el límite de concentración aceptable*.
...
[← 036. Licencias, royalties y propiedad intelectual](../class-08-licencias-royalties-y-propiedad-intelectual/README.md) · [Índice de la parte](../README.md) · [038. Manufactura y venta de productos →](../class-10-manufactura-y-venta-de-productos/README.md)
