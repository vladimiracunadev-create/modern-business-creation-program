...
flowchart TB
    ...
    C --> A1["Business Model Canvas"]
    C --> A2["Actividad clave"]
    C --> A3["Recurso clave"]
...
- *Uso en esta clase:* aporta el marco de «Ley 19.496, comercio electrónico y garantía legal» para verificar si los nueve bloques del modelo son consistentes entre sí.
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para verificar si los nueve bloques del modelo son consistentes entre sí.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para verificar si los nueve bloques del modelo son consistentes entre sí.
