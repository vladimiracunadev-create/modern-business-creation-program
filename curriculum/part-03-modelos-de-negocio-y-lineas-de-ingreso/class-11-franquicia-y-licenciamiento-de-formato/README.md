...
Comprender **franquicia y licenciamiento de formato** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir si el negocio es replicable y bajo qué condiciones se franquicia*.
...
[← 038. Manufactura y venta de productos](../class-10-manufactura-y-venta-de-productos/README.md) · [Índice de la parte](../README.md) · [040. Publicidad, afiliación y contenido →](../class-12-publicidad-afiliacion-y-contenido/README.md)
