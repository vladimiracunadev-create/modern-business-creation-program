...
Comprender **marketplace de dos lados** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*elegir qué lado se subsidia primero y en qué nicho se busca liquidez*.
...
[← 034. Retail físico y omnicanal](../class-06-retail-fisico-y-omnicanal/README.md) · [Índice de la parte](../README.md) · [036. Licencias, royalties y propiedad intelectual →](../class-08-licencias-royalties-y-propiedad-intelectual/README.md)
