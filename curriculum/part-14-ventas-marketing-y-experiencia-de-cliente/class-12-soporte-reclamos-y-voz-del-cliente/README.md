...
Comprender **soporte, reclamos y voz del cliente** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cómo se registran, resuelven y analizan los reclamos*.
...
[← 193. Customer success y expansión](../class-11-customer-success-y-expansion/README.md) · [Índice de la parte](../README.md) · [195. Referidos, partners y canales →](../class-13-referidos-partners-y-canales/README.md)
