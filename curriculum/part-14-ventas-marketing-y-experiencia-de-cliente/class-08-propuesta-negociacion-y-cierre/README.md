...
Comprender **propuesta, negociación y cierre** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la política de concesiones y qué se exige a cambio*.
...
[← 189. Discovery comercial y calificación](../class-07-discovery-comercial-y-calificacion/README.md) · [Índice de la parte](../README.md) · [191. CRM y pipeline →](../class-09-crm-y-pipeline/README.md)
