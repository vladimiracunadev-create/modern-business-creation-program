...
Comprender **prospección b2b** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la lista objetivo y la secuencia de contacto*.
...
[← 187. Publicidad digital y atribución](../class-05-publicidad-digital-y-atribucion/README.md) · [Índice de la parte](../README.md) · [189. Discovery comercial y calificación →](../class-07-discovery-comercial-y-calificacion/README.md)
