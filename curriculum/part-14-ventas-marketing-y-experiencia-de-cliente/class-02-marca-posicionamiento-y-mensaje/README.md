...
Comprender **marca, posicionamiento y mensaje** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el mensaje central y asegurar su consistencia y protección*.
...
[← 183. ICP y segmentación comercial](../class-01-icp-y-segmentacion-comercial/README.md) · [Índice de la parte](../README.md) · [185. Embudo de adquisición →](../class-03-embudo-de-adquisicion/README.md)
