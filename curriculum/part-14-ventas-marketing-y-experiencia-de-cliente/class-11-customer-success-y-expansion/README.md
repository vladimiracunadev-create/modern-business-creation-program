...
Comprender **customer success y expansión** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el indicador de salud de cuenta y las intervenciones por nivel de riesgo*.
...
[← 192. Onboarding de clientes](../class-10-onboarding-de-clientes/README.md) · [Índice de la parte](../README.md) · [194. Soporte, reclamos y voz del cliente →](../class-12-soporte-reclamos-y-voz-del-cliente/README.md)
