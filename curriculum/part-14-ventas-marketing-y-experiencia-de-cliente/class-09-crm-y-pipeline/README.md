...
Comprender **crm y pipeline** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir las reglas de higiene del pipeline y su revisión periódica*.
...
[← 190. Propuesta, negociación y cierre](../class-08-propuesta-negociacion-y-cierre/README.md) · [Índice de la parte](../README.md) · [192. Onboarding de clientes →](../class-10-onboarding-de-clientes/README.md)
