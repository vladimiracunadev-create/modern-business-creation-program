...
**Decisión que habilita:** ejecutar el término de giro en plazo y con la información completa<br>
...
flowchart TB
    ...
    C --> A1["Término de giro"]
    C --> A2["Plazo legal"]
    C --> A3["Impuesto de término de<br/>giro"]
    C --> A4["Certificado de término de<br/>giro"]
    A1 & A2 & A3 & A4 --> D{{"ejecutar el término de giro en<br/>plazo y con la información<br/>completa"}}
    D --> E["Entregable<br/>expediente de término de giro<br/>con declaraciones al día,<br/>cálculo de impuesto final y<br/>certificado obtenido"]
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para ejecutar el término de giro en plazo y con la información completa.
...
- *Uso en esta clase:* aporta el marco de «Carpeta Tributaria Electrónica» para ejecutar el término de giro en plazo y con la información completa.
