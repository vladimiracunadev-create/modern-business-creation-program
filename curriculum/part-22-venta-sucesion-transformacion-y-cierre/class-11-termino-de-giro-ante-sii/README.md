...
Comprender **término de giro ante sii** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*ejecutar el término de giro en plazo y con la información completa*.
...
[← 304. Disolución societaria](../class-10-disolucion-societaria/README.md) · [Índice de la parte](../README.md) · [306. Finiquitos y cierre laboral →](../class-12-finiquitos-y-cierre-laboral/README.md)
