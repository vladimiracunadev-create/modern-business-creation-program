...
Comprender **sucesión familiar o ejecutiva** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir las reglas de sucesión y la separación entre propiedad y gestión*.
...
[← 302. Transición, earn-out y no competencia](../class-08-transicion-earn-out-y-no-competencia/README.md) · [Índice de la parte](../README.md) · [304. Disolución societaria →](../class-10-disolucion-societaria/README.md)
