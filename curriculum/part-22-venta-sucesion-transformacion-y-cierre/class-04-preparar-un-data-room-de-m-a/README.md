...
Comprender **preparar un data room de m&a** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*preparar el data room y definir la liberación por etapas*.
...
[← 297. Valoración para venta](../class-03-valoracion-para-venta/README.md) · [Índice de la parte](../README.md) · [299. Due diligence vendedor →](../class-05-due-diligence-vendedor/README.md)
