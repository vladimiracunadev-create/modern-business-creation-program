...
Comprender **negociación de compraventa empresarial** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*negociar las condiciones principales y el alcance de las garantías*.
...
[← 300. Asset deal versus share deal](../class-06-asset-deal-versus-share-deal/README.md) · [Índice de la parte](../README.md) · [302. Transición, earn-out y no competencia →](../class-08-transicion-earn-out-y-no-competencia/README.md)
