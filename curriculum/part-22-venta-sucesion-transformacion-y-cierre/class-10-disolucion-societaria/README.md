...
**Decisión que habilita:** ejecutar la disolución con las formalidades y el orden correcto<br>
...
flowchart TB
    ...
    C --> A1["Disolución"]
    C --> A2["Liquidación societaria"]
    C --> A3["Distribución del remanente"]
    C --> A4["Publicidad del acto"]
    A1 & A2 & A3 & A4 --> D{{"ejecutar la disolución con las<br/>formalidades y el orden<br/>correcto"}}
    D --> E["Entregable<br/>plan de disolución con<br/>acuerdo, liquidación,<br/>distribución del remanente y<br/>trámites de publicidad"]
...
- *Uso en esta clase:* aporta el marco de «Constitución de empresas» para ejecutar la disolución con las formalidades y el orden correcto.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para ejecutar la disolución con las formalidades y el orden correcto.
