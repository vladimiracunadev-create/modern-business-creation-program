...
**Decisión que habilita:** ejecutar el cierre completo de habilitaciones, contratos, datos y cuentas<br>
...
flowchart TB
    ...
    C --> A1["Cierre de permisos"]
    C --> A2["Cancelación de patente"]
    C --> A3["Eliminación o entrega de<br/>datos"]
    C --> A4["Cierre de cuentas"]
    A1 & A2 & A3 & A4 --> D{{"ejecutar el cierre completo de<br/>habilitaciones, contratos,<br/>datos y cuentas"}}
    D --> E["Entregable<br/>checklist de cierre operativo<br/>con permisos, contratos, datos<br/>personales y cuentas, con<br/>constancia por ítem"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para ejecutar el cierre completo de habilitaciones, contratos, datos y cuentas.
...
- *Uso en esta clase:* aporta el marco de «Nuevos contribuyentes, inicio de actividades y DTE» para ejecutar el cierre completo de habilitaciones, contratos, datos y cuentas.
