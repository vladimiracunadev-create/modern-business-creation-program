...
Comprender **preparación para ley 21.719 desde 1-dic-2026** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*planificar la adecuación de la empresa antes de la entrada en vigencia*.
...
[← 146. Privacidad bajo Ley 19.628 vigente](../class-06-privacidad-bajo-ley-19-628-vigente/README.md) · [Índice de la parte](../README.md) · [148. Mapa de datos y bases de licitud →](../class-08-mapa-de-datos-y-bases-de-licitud/README.md)
