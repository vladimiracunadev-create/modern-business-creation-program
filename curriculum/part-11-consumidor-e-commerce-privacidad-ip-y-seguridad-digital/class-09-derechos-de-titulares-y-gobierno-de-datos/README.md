...
Comprender **derechos de titulares y gobierno de datos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*habilitar el canal y el procedimiento de atención de derechos*.
...
[← 148. Mapa de datos y bases de licitud](../class-08-mapa-de-datos-y-bases-de-licitud/README.md) · [Índice de la parte](../README.md) · [150. Registro de marca en INAPI →](../class-10-registro-de-marca-en-inapi/README.md)
