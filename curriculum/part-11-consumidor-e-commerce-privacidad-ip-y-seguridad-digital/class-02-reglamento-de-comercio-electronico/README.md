...
Comprender **reglamento de comercio electrónico** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*ajustar el flujo de compra del sitio a las obligaciones del reglamento*.
...
[← 141. Ley del Consumidor aplicada al negocio](../class-01-ley-del-consumidor-aplicada-al-negocio/README.md) · [Índice de la parte](../README.md) · [143. Información de precio, stock, despacho y retracto →](../class-03-informacion-de-precio-stock-despacho-y-retracto/README.md)
