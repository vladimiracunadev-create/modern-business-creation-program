...
Comprender **cotización, orden de compra y aceptación** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir qué operaciones van con contrato marco y cuáles con cotización y orden*.
...
[← 127. Anatomía de un contrato comercial](../class-01-anatomia-de-un-contrato-comercial/README.md) · [Índice de la parte](../README.md) · [129. Contrato de prestación de servicios →](../class-03-contrato-de-prestacion-de-servicios/README.md)
