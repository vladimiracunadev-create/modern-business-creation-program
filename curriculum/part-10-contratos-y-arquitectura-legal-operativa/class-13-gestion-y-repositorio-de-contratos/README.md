...
Comprender **gestión y repositorio de contratos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir dónde viven los contratos y quién controla vencimientos*.
...
[← 138. Contratos con proveedores críticos](../class-12-contratos-con-proveedores-criticos/README.md) · [Índice de la parte](../README.md) · [140. Cuándo debe intervenir un abogado →](../class-14-cuando-debe-intervenir-un-abogado/README.md)
