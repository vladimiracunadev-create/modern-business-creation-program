...
**Decisión que habilita:** definir volumen, mecanismo de ajuste de precio y consecuencias del incumplimiento<br>
...
flowchart TB
    ...
    C --> A1["Contrato de suministro"]
    C --> A2["Volumen mínimo"]
    C --> A3["Cláusula de ajuste"]
    C --> A4["Exclusividad"]
    A1 & A2 & A3 & A4 --> D{{"definir volumen, mecanismo de<br/>ajuste de precio y<br/>consecuencias del<br/>incumplimiento"}}
    D --> E["Entregable<br/>contrato de suministro con<br/>volumen, fórmula de ajuste,<br/>plazos de entrega y<br/>penalidades"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para definir volumen, mecanismo de ajuste de precio y consecuencias del incumplimiento.
