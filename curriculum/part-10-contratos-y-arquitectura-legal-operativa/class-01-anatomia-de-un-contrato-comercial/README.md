...
Comprender **anatomía de un contrato comercial** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar dónde queda el riesgo en cada contrato antes de firmar*.
...
[Índice de la parte](../README.md) · [128. Cotización, orden de compra y aceptación →](../class-02-cotizacion-orden-de-compra-y-aceptacion/README.md)
