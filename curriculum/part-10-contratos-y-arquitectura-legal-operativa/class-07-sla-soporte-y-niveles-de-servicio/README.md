...
Comprender **sla, soporte y niveles de servicio** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir métricas, exclusiones y consecuencias del nivel de servicio*.
...
[← 132. Propiedad intelectual en contratos](../class-06-propiedad-intelectual-en-contratos/README.md) · [Índice de la parte](../README.md) · [134. Limitación de responsabilidad y garantías →](../class-08-limitacion-de-responsabilidad-y-garantias/README.md)
