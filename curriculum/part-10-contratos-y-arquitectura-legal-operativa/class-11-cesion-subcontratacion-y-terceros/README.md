...
Comprender **cesión, subcontratación y terceros** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir qué se puede ceder o subcontratar y con qué controles*.
...
[← 136. Jurisdicción, arbitraje y solución de controversias](../class-10-jurisdiccion-arbitraje-y-solucion-de-controversias/README.md) · [Índice de la parte](../README.md) · [138. Contratos con proveedores críticos →](../class-12-contratos-con-proveedores-criticos/README.md)
