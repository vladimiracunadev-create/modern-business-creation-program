...
Comprender **continuidad de proveedores críticos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cómo se cubre la falla de cada proveedor crítico*.
...
[← 178. Make or buy](../class-10-make-or-buy/README.md) · [Índice de la parte](../README.md) · [180. Mantenimiento y activos operativos →](../class-12-mantenimiento-y-activos-operativos/README.md)
