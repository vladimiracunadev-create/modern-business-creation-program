...
Comprender **gestión de calidad y no conformidades** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cómo se registran y se cierran las no conformidades*.
...
[← 175. Logística directa e inversa](../class-07-logistica-directa-e-inversa/README.md) · [Índice de la parte](../README.md) · [177. Capacidad y cuellos de botella →](../class-09-capacidad-y-cuellos-de-botella/README.md)
