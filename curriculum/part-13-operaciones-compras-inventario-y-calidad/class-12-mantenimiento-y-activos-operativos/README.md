...
Comprender **mantenimiento y activos operativos** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*priorizar el mantenimiento según criticidad y costo de la falla*.
...
[← 179. Continuidad de proveedores críticos](../class-11-continuidad-de-proveedores-criticos/README.md) · [Índice de la parte](../README.md) · [181. Indicadores OTIF, fill rate y lead time →](../class-13-indicadores-otif-fill-rate-y-lead-time/README.md)
