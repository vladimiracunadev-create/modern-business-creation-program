...
Comprender **sop y controles operacionales** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*documentar los procedimientos críticos con controles incorporados*.
...
[← 169. Diseño de procesos end-to-end](../class-01-diseno-de-procesos-end-to-end/README.md) · [Índice de la parte](../README.md) · [171. Compras y homologación de proveedores →](../class-03-compras-y-homologacion-de-proveedores/README.md)
