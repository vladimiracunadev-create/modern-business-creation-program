...
**Decisión que habilita:** preparar el data room y corregir hallazgos antes de abrir el proceso<br>
...
flowchart TB
    ...
    C --> A3["Hallazgo"]
    C --> A4["Índice"]
    A1 & A2 & A3 & A4 --> D{{"preparar el data room y<br/>corregir hallazgos antes de<br/>abrir el proceso"}}
    D --> E["Entregable<br/>data room con índice completo<br/>y checklist de hallazgos<br/>corregidos previamente"]
