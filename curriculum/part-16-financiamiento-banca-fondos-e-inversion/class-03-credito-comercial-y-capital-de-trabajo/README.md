...
**Decisión que habilita:** preparar la carpeta bancaria y evaluar las condiciones antes de aceptar<br>
...
flowchart TB
    ...
    C --> A1["Línea de crédito"]
    C --> A2["Carpeta bancaria"]
    C --> A3["Covenant"]
    C --> A4["Garantía"]
    A1 & A2 & A3 & A4 --> D{{"preparar la carpeta bancaria y<br/>evaluar las condiciones antes<br/>de aceptar"}}
    D --> E["Entregable<br/>carpeta bancaria completa con<br/>estados financieros, carpeta<br/>tributaria y análisis de<br/>covenants"]
...
- *Uso en esta clase:* aporta el marco de «Carpeta Tributaria Electrónica» para preparar la carpeta bancaria y evaluar las condiciones antes de aceptar.
...
- *Uso en esta clase:* aporta el marco de «Registro de Prestadores de Servicios Financieros · Ley 21.521» para preparar la carpeta bancaria y evaluar las condiciones antes de aceptar.
