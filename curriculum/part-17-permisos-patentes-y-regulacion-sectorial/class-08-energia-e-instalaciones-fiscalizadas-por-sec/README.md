...
Comprender **energía e instalaciones fiscalizadas por sec** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*asegurar que las instalaciones estén ejecutadas y declaradas conforme a la normativa*.
...
[← 231. Construcción, LGUC y OGUC](../class-07-construccion-lguc-y-oguc/README.md) · [Índice de la parte](../README.md) · [233. Telecomunicaciones y SUBTEL →](../class-09-telecomunicaciones-y-subtel/README.md)
