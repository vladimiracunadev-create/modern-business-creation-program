...
Comprender **prochile y entrada a mercados** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir el mercado objetivo y la estrategia de entrada con apoyo institucional*.
...
[← 250. IVA, retenciones y doble tributación](../class-12-iva-retenciones-y-doble-tributacion/README.md) · [Índice de la parte](../README.md) · [252. Filial, partner o venta remota →](../class-14-filial-partner-o-venta-remota/README.md)
