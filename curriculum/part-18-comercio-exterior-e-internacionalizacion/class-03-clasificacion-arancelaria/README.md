...
Comprender **clasificación arancelaria** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*clasificar correctamente la mercancía antes de operar*.
...
[← 240. Incoterms y responsabilidades](../class-02-incoterms-y-responsabilidades/README.md) · [Índice de la parte](../README.md) · [242. Importación de bienes a Chile →](../class-04-importacion-de-bienes-a-chile/README.md)
