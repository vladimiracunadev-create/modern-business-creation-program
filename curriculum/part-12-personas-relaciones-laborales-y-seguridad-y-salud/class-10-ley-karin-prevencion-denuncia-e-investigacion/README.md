...
Comprender **ley karin: prevención, denuncia e investigación** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*implementar protocolo, canal y procedimiento de investigación conforme a la ley*.
...
[← 163. Reglamento interno y políticas](../class-09-reglamento-interno-y-politicas/README.md) · [Índice de la parte](../README.md) · [165. Subcontratación y servicios transitorios →](../class-11-subcontratacion-y-servicios-transitorios/README.md)
