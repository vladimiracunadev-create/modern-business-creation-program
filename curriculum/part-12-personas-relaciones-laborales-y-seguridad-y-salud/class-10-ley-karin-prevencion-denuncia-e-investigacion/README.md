...
**Decisión que habilita:** implementar protocolo, canal y procedimiento de investigación conforme a la ley<br>
...
flowchart TB
    ...
    C --> A1["Ley 21.643"]
    C --> A2["Protocolo de prevención"]
    C --> A3["Canal de denuncia"]
    C --> A4["Investigación"]
    A1 & A2 & A3 & A4 --> D{{"implementar protocolo, canal y<br/>procedimiento de investigación<br/>conforme a la ley"}}
    D --> E["Entregable<br/>protocolo Ley Karin con canal<br/>habilitado, procedimiento de<br/>investigación y registro de<br/>casos"]
...
- *Uso en esta clase:* aporta el marco de «Relaciones laborales y obligaciones del empleador» para implementar protocolo, canal y procedimiento de investigación conforme a la ley.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para implementar protocolo, canal y procedimiento de investigación conforme a la ley.
