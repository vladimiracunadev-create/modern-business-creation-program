...
**Decisión que habilita:** elegir la figura correcta según los hechos reales de la relación<br>
**Entregable:** análisis de la relación con indicadores de subordinación y decisión fundada de la figura
...
3. **Decidir** —elegir la figura correcta según los hechos reales de la relación— y justificar la decisión por escrito.
...
flowchart TB
    ...
    C --> A1["Vínculo de subordinación"]
    C --> A2["Honorarios"]
    C --> A3["Externalización"]
    C --> A4["Reclasificación"]
    A1 & A2 & A3 & A4 --> D{{"elegir la figura correcta<br/>según los hechos reales de la<br/>relación"}}
    D --> E["Entregable<br/>análisis de la relación con<br/>indicadores de subordinación y<br/>decisión fundada de la figura"]
...
La calificación de la relación no depende del nombre del contrato sino de los hechos: horario, supervisión, exclusividad, herramientas y continuidad. Un contrato a honorarios con subordinación se reclasifica como laboral, con cobro retroactivo de cotizaciones, indemnizaciones y multas.
...
Análisis de la relación con indicadores de subordinación y decisión fundada de la figura.
...
- [ ] los indicadores de subordinación están evaluados uno a uno
- [ ] la decisión considera el costo de una eventual reclasificación
...
- Usar honorarios para evitar costos laborales en una relación con subordinación.
- Externalizar una función crítica sin control de cumplimiento del proveedor.
...
- *Uso en esta clase:* aporta el marco de «Relaciones laborales y obligaciones del empleador» para elegir la figura correcta según los hechos reales de la relación.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para elegir la figura correcta según los hechos reales de la relación.
