...
Comprender **cuándo contratar versus externalizar** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*elegir la figura correcta según los hechos reales de la relación*.
...
[Índice de la parte](../README.md) · [156. Contrato de trabajo y cláusulas esenciales →](../class-02-contrato-de-trabajo-y-clausulas-esenciales/README.md)
