...
Comprender **remuneraciones imponibles y no imponibles** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*diseñar la estructura de remuneración con haberes correctamente clasificados*.
...
[← 159. Control de asistencia, horas extra y descansos](../class-05-control-de-asistencia-horas-extra-y-descansos/README.md) · [Índice de la parte](../README.md) · [161. Cotizaciones previsionales y seguridad social →](../class-07-cotizaciones-previsionales-y-seguridad-social/README.md)
