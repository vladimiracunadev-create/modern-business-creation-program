...
Comprender **vacaciones, permisos y licencias** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*controlar el devengo y uso de feriados, permisos y licencias*.
...
[← 161. Cotizaciones previsionales y seguridad social](../class-07-cotizaciones-previsionales-y-seguridad-social/README.md) · [Índice de la parte](../README.md) · [163. Reglamento interno y políticas →](../class-09-reglamento-interno-y-politicas/README.md)
