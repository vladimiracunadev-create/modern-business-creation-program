...
Comprender **cobranza y gestión de incobrables** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la política de cobranza y los criterios de castigo*.
...
[← 287. Renegociación de deuda](../class-07-renegociacion-de-deuda/README.md) · [Índice de la parte](../README.md) · [289. Ley 20.720: reorganización y liquidación →](../class-09-ley-20-720-reorganizacion-y-liquidacion/README.md)
