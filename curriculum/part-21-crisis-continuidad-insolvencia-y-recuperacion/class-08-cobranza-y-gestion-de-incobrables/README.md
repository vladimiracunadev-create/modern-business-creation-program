...
**Decisión que habilita:** definir la política de cobranza y los criterios de castigo<br>
...
flowchart TB
    ...
    C --> A1["Cobranza"]
    C --> A2["Mérito ejecutivo"]
    C --> A3["Incobrable"]
    C --> A4["Castigo"]
    A1 & A2 & A3 & A4 --> D{{"definir la política de<br/>cobranza y los criterios de<br/>castigo"}}
    D --> E["Entregable<br/>procedimiento de cobranza por<br/>tramos de antigüedad con<br/>criterios de acción y de<br/>castigo"]
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para definir la política de cobranza y los criterios de castigo.
