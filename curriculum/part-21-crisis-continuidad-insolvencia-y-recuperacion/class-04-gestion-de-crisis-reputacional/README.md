...
Comprender **gestión de crisis reputacional** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir vocería, mensaje y canales antes de que ocurra la crisis*.
...
[← 283. Disaster Recovery para tecnología](../class-03-disaster-recovery-para-tecnologia/README.md) · [Índice de la parte](../README.md) · [285. Fuga de caja y plan de 30 días →](../class-05-fuga-de-caja-y-plan-de-30-dias/README.md)
