...
Comprender **business continuity plan** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir qué procesos se restablecen primero y con qué recursos*.
...
[← 281. Mapa de amenazas y escenarios de crisis](../class-01-mapa-de-amenazas-y-escenarios-de-crisis/README.md) · [Índice de la parte](../README.md) · [283. Disaster Recovery para tecnología →](../class-03-disaster-recovery-para-tecnologia/README.md)
