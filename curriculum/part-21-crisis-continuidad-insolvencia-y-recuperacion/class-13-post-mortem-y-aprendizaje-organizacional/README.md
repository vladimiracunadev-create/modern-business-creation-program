...
Comprender **post-mortem y aprendizaje organizacional** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir cómo se analizan los eventos adversos y cómo se incorporan los aprendizajes*.
...
[← 292. Comunicaciones con trabajadores y clientes](../class-12-comunicaciones-con-trabajadores-y-clientes/README.md) · [Índice de la parte](../README.md) · [294. Plan de recuperación y vuelta a crecimiento →](../class-14-plan-de-recuperacion-y-vuelta-a-crecimiento/README.md)
