...
Comprender **fuga de caja y plan de 30 días** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*ejecutar el plan de estabilización de caja con prioridades definidas*.
...
[← 284. Gestión de crisis reputacional](../class-04-gestion-de-crisis-reputacional/README.md) · [Índice de la parte](../README.md) · [286. Cliente o proveedor crítico en insolvencia →](../class-06-cliente-o-proveedor-critico-en-insolvencia/README.md)
