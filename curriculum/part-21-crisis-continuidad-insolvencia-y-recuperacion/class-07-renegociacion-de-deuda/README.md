...
**Decisión que habilita:** preparar y ejecutar la renegociación con propuesta fundada<br>
...
flowchart TB
    ...
    C --> A2["Reprogramación"]
    C --> A3["Quita"]
    C --> A4["Posición negociadora"]
    A1 & A2 & A3 & A4 --> D{{"preparar y ejecutar la<br/>renegociación con propuesta<br/>fundada"}}
    D --> E["Entregable<br/>propuesta de renegociación con<br/>flujo proyectado, capacidad de<br/>pago demostrada y calendario<br/>ofrecido"]
...
- *Uso en esta clase:* aporta el marco de «Registro de Prestadores de Servicios Financieros · Ley 21.521» para preparar y ejecutar la renegociación con propuesta fundada.
...
- *Uso en esta clase:* aporta el marco de «Normativa oficial consolidada» para preparar y ejecutar la renegociación con propuesta fundada.
