...
Comprender **protección de documentación y evidencia** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar la documentación crítica y asegurar su custodia y disponibilidad*.
...
[← 289. Ley 20.720: reorganización y liquidación](../class-09-ley-20-720-reorganizacion-y-liquidacion/README.md) · [Índice de la parte](../README.md) · [291. Plan de reducción de costos sin destruir capacidad →](../class-11-plan-de-reduccion-de-costos-sin-destruir-capacidad/README.md)
