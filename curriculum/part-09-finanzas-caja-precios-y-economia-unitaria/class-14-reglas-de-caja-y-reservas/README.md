...
Comprender **reglas de caja y reservas** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*fijar caja mínima, reservas y reglas de retiro por escrito*.
...
[← 125. Dashboard financiero del fundador](../class-13-dashboard-financiero-del-fundador/README.md) · [Índice de la parte](../README.md) · [127. Anatomía de un contrato comercial →](../../part-10-contratos-y-arquitectura-legal-operativa/class-01-anatomia-de-un-contrato-comercial/README.md)
