...
Comprender **dashboard financiero del fundador** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir los pocos indicadores que la empresa revisará efectivamente*.
...
[← 124. Escenarios base, estrés y supervivencia](../class-12-escenarios-base-estres-y-supervivencia/README.md) · [Índice de la parte](../README.md) · [126. Reglas de caja y reservas →](../class-14-reglas-de-caja-y-reservas/README.md)
