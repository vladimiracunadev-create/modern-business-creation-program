...
Comprender **ciclo de conversión de efectivo** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar qué palanca del ciclo se ataca primero y cuánta caja libera*.
...
[← 121. Rotación, ticket y merma para comercio](../class-09-rotacion-ticket-y-merma-para-comercio/README.md) · [Índice de la parte](../README.md) · [123. Deuda buena, deuda mala y costo de capital →](../class-11-deuda-buena-deuda-mala-y-costo-de-capital/README.md)
