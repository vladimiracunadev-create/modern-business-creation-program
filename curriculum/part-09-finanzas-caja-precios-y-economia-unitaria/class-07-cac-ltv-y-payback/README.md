...
Comprender **cac, ltv y payback** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*determinar si el costo de adquisición es recuperable en un plazo financiable*.
...
[← 118. Pricing basado en costos, valor y mercado](../class-06-pricing-basado-en-costos-valor-y-mercado/README.md) · [Índice de la parte](../README.md) · [120. MRR, ARR, churn y NRR para suscripciones →](../class-08-mrr-arr-churn-y-nrr-para-suscripciones/README.md)
