...
Comprender **mrr, arr, churn y nrr para suscripciones** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*medir la retención neta y decidir si invertir en adquisición o en retención*.
...
[← 119. CAC, LTV y payback](../class-07-cac-ltv-y-payback/README.md) · [Índice de la parte](../README.md) · [121. Rotación, ticket y merma para comercio →](../class-09-rotacion-ticket-y-merma-para-comercio/README.md)
