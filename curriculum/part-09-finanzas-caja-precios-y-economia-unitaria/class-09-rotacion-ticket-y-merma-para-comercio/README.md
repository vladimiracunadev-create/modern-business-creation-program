...
Comprender **rotación, ticket y merma para comercio** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir la mezcla de productos según rotación y contribución, no solo margen*.
...
[← 120. MRR, ARR, churn y NRR para suscripciones](../class-08-mrr-arr-churn-y-nrr-para-suscripciones/README.md) · [Índice de la parte](../README.md) · [122. Ciclo de conversión de efectivo →](../class-10-ciclo-de-conversion-de-efectivo/README.md)
