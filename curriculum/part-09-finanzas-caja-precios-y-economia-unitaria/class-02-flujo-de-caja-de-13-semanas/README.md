...
Comprender **flujo de caja de 13 semanas** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*instalar el flujo de 13 semanas como rutina semanal de gestión*.
...
[← 113. Presupuesto de arranque](../class-01-presupuesto-de-arranque/README.md) · [Índice de la parte](../README.md) · [115. Capital de trabajo →](../class-03-capital-de-trabajo/README.md)
