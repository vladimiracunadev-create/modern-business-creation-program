...
Comprender **de fundador a organización** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar qué decisiones deben dejar de pasar por el fundador*.
...
[Índice de la parte](../README.md) · [268. Diseño organizacional por etapas →](../class-02-diseno-organizacional-por-etapas/README.md)
