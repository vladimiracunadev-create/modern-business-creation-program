...
Comprender **consejo asesor y directorio** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*decidir si corresponde consejo asesor o directorio y con qué agenda*.
...
[← 276. Adquisición de competidores o capacidades](../class-10-adquisicion-de-competidores-o-capacidades/README.md) · [Índice de la parte](../README.md) · [278. Auditoría externa y control de gestión →](../class-12-auditoria-externa-y-control-de-gestion/README.md)
