...
Comprender **procesos que deben estandarizarse antes de crecer** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*identificar qué procesos deben estandarizarse antes de crecer*.
...
Gerencia general, control de gestión, abogado corporativo, consultor organizacional. La participación concreta depende del riesgo, el tamaño de la
...
[← 271. Hiring plan y workforce planning](../class-05-hiring-plan-y-workforce-planning/README.md) · [Índice de la parte](../README.md) · [273. Multi-sucursal y expansión geográfica →](../class-07-multi-sucursal-y-expansion-geografica/README.md)
