...
Comprender **diseño organizacional por etapas** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir la estructura de roles que corresponde a la etapa actual*.
...
[← 267. De fundador a organización](../class-01-de-fundador-a-organizacion/README.md) · [Índice de la parte](../README.md) · [269. Delegación y accountability →](../class-03-delegacion-y-accountability/README.md)
