...
Comprender **delegación y accountability** dentro del sistema de creación y operación de una empresa,
y quedar en condiciones de tomar la decisión que esta clase habilita:
*definir resultados comprometidos, límites de decisión e instancias de rendición*.
...
[← 268. Diseño organizacional por etapas](../class-02-diseno-organizacional-por-etapas/README.md) · [Índice de la parte](../README.md) · [270. Presupuesto por centros de responsabilidad →](../class-04-presupuesto-por-centros-de-responsabilidad/README.md)
