...
# 🏛️ Modern Business Creation Program

## **24 partes · 336 clases · de la idea a la constitución, la operación, la crisis y la salida**

**El programa más completo en español para entender y construir una empresa real en Chile: qué decisión dispara qué obligación, quién es responsable y qué evidencia debe quedar.**

[![CI](https://github.com/vladimiracunadev-create/modern-business-creation-program/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/vladimiracunadev-create/modern-business-creation-program/actions/workflows/ci.yml)
...
[![Python](https://img.shields.io/badge/Python-3.12%2B-3776AB?style=flat-square&logo=python&logoColor=white)](scripts/)
[![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-sitio%20vivo-222?style=flat-square&logo=githubpages&logoColor=white)](https://vladimiracunadev-create.github.io/modern-business-creation-program/)
[![SII](https://img.shields.io/badge/SII-ciclo%20tributario-c0392b?style=flat-square)](curriculum/part-07-sii-y-ciclo-tributario-de-principio-a-fin/README.md)
...
> [!IMPORTANT]
> Este repositorio es **material educativo y de ingeniería empresarial**. No reemplaza asesoría
> legal, tributaria, contable, laboral, sanitaria, financiera ni regulatoria para un caso concreto.
> La legislación cambia y una misma actividad puede tener exigencias municipales o sectoriales
> distintas. Antes de ejecutar un trámite hay que **verificar la fuente oficial vigente** y, cuando
> corresponda, validar con el profesional competente.

## 🎯 Qué es esto

Un currículo secuencial de **336 clases en 24 partes** que recorre el ciclo completo de una empresa:

`descubrimiento → validación → modelo → estrategia → sociedad → constitución → SII → contabilidad → caja → contratos → consumidor y datos → personas → operación → ventas → tecnología → financiamiento → permisos → comercio exterior → compliance → escalamiento → crisis → salida`

El principio que ordena todo el material:

> Una empresa no es el certificado de constitución. Es un sistema que convierte capital, personas,
> activos, conocimiento, tecnología y permisos en valor para clientes, mientras cumple obligaciones
> legales, tributarias, laborales, financieras y operativas.

No se trata de "memorizar la ley". Se trata de saber **qué decisión dispara qué obligación, quién es
responsable y qué evidencia debe quedar**.
...
![Fuentes revalidadas](https://img.shields.io/badge/fuentes%20revalidadas-2026--09--01-blue)
...
|---|---|---:|:---:|---|
| [Normativa oficial consolidada](https://www.bcn.cl/leychile/) | Biblioteca del Congreso Nacional · LeyChile | 255 | ✅ | 2026-09-01 |
| [Nuevos contribuyentes, inicio de actividades y DTE](https://www.sii.cl/ayudas/nuevos_contribuyentes/boleta-vys-facturador.html) | Servicio de Impuestos Internos | 108 | ✅ | 2026-09-01 |
| [Ley 19.496, comercio electrónico y garantía legal](https://www.sernac.cl/) | Servicio Nacional del Consumidor | 62 | ✅ | 2026-09-01 |
| [Innovación, inversión y garantías](https://www.corfo.cl/) | Corporación de Fomento de la Producción | 53 | ✅ | 2026-09-01 |
| [Relaciones laborales y obligaciones del empleador](https://www.dt.gob.cl/) | Dirección del Trabajo | 47 | ✅ | 2026-09-01 |
...
| [Carpeta Tributaria Electrónica](https://zeus.sii.cl/dii_doc/carpeta_tributaria/html/generar_carpeta.htm) | Servicio de Impuestos Internos | 26 | ✅ | 2026-09-01 |
...
| [Sujetos obligados · Ley 19.913](https://www.uaf.cl/es-cl/sujetos-obligados/sector-privado/quienes-deben-reportar) | Unidad de Análisis Financiero | 10 | ✅ | 2026-09-01 |
...
| [Registro de Compras y Ventas](https://www.sii.cl/destacados/f29/registrocompraventas.htm) | Servicio de Impuestos Internos | 5 | ✅ | 2026-09-01 |
| [Sistema de Evaluación de Impacto Ambiental](https://www.sea.gob.cl/) | Servicio de Evaluación Ambiental | 4 | ✅ | 2026-09-01 |
| [Ventanilla única de comercio exterior](https://www.sicexchile.cl/) | Sistema Integrado de Comercio Exterior | 4 | ⚠️ | 2026-08-19 |
...
⚠️ **6 fuente(s) no resolvieron en la última pasada:**

- **Registro de Empresas y Sociedades / ChileAtiende — Constitución de empresas** · `2026-09-01: HTTP 403`  
  Sigue citada y conserva su última fecha buena (2026-08-19). No se ha borrado.
- **Servicio de Cooperación Técnica — Fomento para micro y pequeñas empresas** · `2026-09-01: HTTP 301`  
  Sigue citada y conserva su última fecha buena (2026-08-19). No se ha borrado.
- **ChileAtiende · Autoridad Sanitaria Regional — Autorización sanitaria de alimentos** · `2026-09-01: HTTP 403`  
  Sigue citada y conserva su última fecha buena (2026-08-19). No se ha borrado.
- **Servicio Nacional de Aduanas — Importación, exportación y clasificación arancelaria** · `2026-09-01: HTTP 403`  
  Sigue citada y conserva su última fecha buena (2026-08-19). No se ha borrado.
- **ProChile — Exportación de servicios** · `2026-09-01: HTTP 404`  
...
Última revalidación: **2026-09-01** · 22/28 fuentes citadas resolvieron ·
...
falla si un README quedó desincronizado respecto de su manifiesto.

## 🧭 Ruta maestra

1. Descubrir un problema real.
2. Validar cliente, demanda y disposición a pagar.
3. Diseñar modelo de negocio y estrategia.
4. Elegir forma societaria y reglas entre socios.
5. Constituir la persona jurídica.
6. Obtener RUT e iniciar actividades en SII.
7. Seleccionar régimen tributario y habilitar DTE.
8. Resolver domicilio, patente municipal y permisos sectoriales.
9. Abrir infraestructura financiera y contable.
10. Diseñar contratos, protección de datos, propiedad intelectual y compliance.
11. Contratar personas y cumplir normativa laboral y de seguridad y salud.
12. Operar compras, inventario, calidad, ventas y postventa.
13. Controlar caja, impuestos, riesgos, seguridad y métricas.
14. Financiar, exportar y escalar.
15. Prepararse para crisis, reorganización, venta, sucesión o cierre.

Detalle en [`docs/00_MASTER_FLOW.md`](docs/00_MASTER_FLOW.md).
...
El programa está calibrado a la realidad chilena vigente a la **fecha base 07-08-2026**:

- **Ley 21.719** de protección de datos personales: vigencia el **1 de diciembre de 2026**; la parte 11 trabaja la transición desde la Ley 19.628.
- **Ley 21.561**: jornada ordinaria de **42 horas semanales desde el 26 de abril de 2026**, camino a 40 horas en 2028.
- **Ley 21.643 (Ley Karin)**: protocolo, canal de denuncias e investigación obligatorios.
- **Ley 21.595** de delitos económicos: catálogo ampliado de responsabilidad penal de la persona jurídica.
- **Ley 21.713** de cumplimiento tributario: facultades reforzadas y exigencia de razón de negocios documentada.
- **Ley 21.521 Fintec** y Sistema de Finanzas Abiertas de la CMF.
- **Ley 21.663** Marco de Ciberseguridad y la ANCI.
...
- Material educativo; no constituye asesoría profesional para un caso concreto.
